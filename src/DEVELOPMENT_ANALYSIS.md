...
-   **Cumplimiento de Requisitos Funcionales:** Se realizará una validación exhaustiva de cada funcionalidad descrita:
    ...
    -   ¿Puede el camarero iniciar sesión, tomar un pedido, añadir notas y enviarlo?
    -   ¿Puede el cajero ver las mesas ocupadas, procesar pagos (simulados) y generar un recibo?
...
-   **Pruebas de Rendimiento:** Se evaluará la velocidad y fluidez de la aplicación utilizando herramientas estándar:
    -   **Velocidad de Carga:** Se medirán los tiempos de carga inicial de las páginas (especialmente la de inicio de sesión y la vista de mesas) con herramientas como Google PageSpeed Insights.
...
-   **Medición de Reducción de Errores Operativos:** Se propondrá un método para medir el impacto real del sistema en el restaurante:
    ...
    -   Se comparará esta métrica con los datos previos a la implementación (si existen) o con un estándar del sector para demostrar una reducción cuantificable de errores, lo que se traduce en ahorro de costos y mejora en la satisfacción del cliente.